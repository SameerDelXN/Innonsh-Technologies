    ...
    <div className="min-h-screen bg-gradient-to-b from-[#F5F7FA] to-[#E3E9F0] p-10 phone:p-4">
      ...
      <div className="grid grid-cols-4 gap-6 mb-16 phone:grid-cols-2">
        {stats.map((stat, index) => (
          ...
          >
            <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#B32AFF] to-[#4C24B1] mb-2">
              {stat.number}
            </h3>
      ...
      <div className="space-y-6 mb-16">
        {milestones.map((milestone, index) => (
          <motion.div
            ...
            transition={{ delay: index * 0.1 }}
            className="bg-white rounded-xl shadow-lg p-6 flex items-start gap-6 group hover:scale-[1.02] transition-transform"
          >
            <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#B32AFF] to-[#4C24B1]">
              {milestone.year}
            </div>
            <div>

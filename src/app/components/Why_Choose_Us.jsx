...
const Why_Choose_Us = () => {
  return (
    <div className='w-full min-h-[100vh] p-10 bg-gradient-to-b from-[#F5F7FA] to-[#E3E9F0] flex flex-col items-start relative phone:p-2 phone:pt-10'>
      ...
      <div className='flex flex-col items-start gap-3'>
        ...
        <hr className="w-72 h-0.5 bg-gradient-to-r from-[#B32AFF] to-[#4C24B1] border-0 rounded" />
      ...
      <div className="relative w-full flex justify-center items-center mt-16 min-h-[50vh]">
        {/* Card 1 (Top-Left) */}
        <div className="absolute top-0 left-32 phone:left-3 w-80 h-40 phone:w-40 phone:h-32 bg-gradient-to-r from-[#B32AFF] to-[#4C24B1] bg-opacity-70 text-white shadow-lg rounded-lg flex flex-col items-center gap-2 justify-center text-center p-4 border border-[#e4e4e4]">
  ...
  <p className="text-sm phone:text-xs">Automate repetitive tasks with intelligent solutions.</p>
        ...
        {/* Card 2 (Top-Right) */}
        <div className="absolute top-0 right-32 phone:right-3 w-80 h-40 phone:w-40 phone:h-32 bg-gradient-to-r from-[#B32AFF] to-[#4C24B1] bg-opacity-70 text-white shadow-lg rounded-lg flex flex-col items-center gap-2 justify-center text-center p-4 border border-[#e4e4e4]">
  ...
  <p className="text-sm phone:text-xs">Flexible solutions that grow with your business.</p>
        ...
        {/* Card 3 (Bottom-Left) */}
        <div className="absolute top-64 left-10 w-80 h-40 phone:top-44 phone:left-3 phone:w-40 phone:h-32 bg-gradient-to-r from-[#B32AFF] to-[#4C24B1] bg-opacity-70 text-white shadow-lg rounded-lg flex flex-col items-center gap-2 justify-center text-center p-4 border border-[#e4e4e4]">
  ...
  <p className="text-sm phone:text-xs">GDPR, SOC2, and ISO-certified security compliance.</p>
        ...
        {/* Card 4 (Bottom-Right) */}
        <div className="absolute top-64 right-10 phone:top-44 phone:right-3 w-80 h-40 phone:w-40 phone:h-32 bg-gradient-to-r from-[#B32AFF] to-[#4C24B1] bg-opacity-70 text-white shadow-lg rounded-lg flex flex-col items-center gap-2 justify-center text-center p-4 border border-[#e4e4e4]">
